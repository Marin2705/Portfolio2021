...
function Details(props) {
  ...
  let projectFigClass = "projectFig m-auto text-center mt-20 pb-10 ";
  props.link && (
    projectFigClass += 'cursor-pointer'
  );

  return (
    <div className="safari:w-screen w-screen h-screen bg-mygray lg:h-full z-40 fixed top-0 left-full lg:w-1/2 flex justify-center items-center overflow-y-scroll" id="details">
      <div className="w-4/5 max-h-[85%]" style={opacity} id="animateDetails">
        <svg className="cursor-pointer mb-8 lg:hidden safari:block" width="45" height="30" viewBox="0 0 45 30" fill="none" xmlns="http://www.w3.org/2000/svg" id="arrowDetails">
